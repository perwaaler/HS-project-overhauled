...
targetTypes = {'sigSymptVHD','sigAsymptVHD','ARsigSympt','sigVHD31',...
                    'AR','MR','AS','MS','costumTarget'};
close all
for i=1:Nsplits
    ...
    if targetType(2)=='R'
        ...
        % default is default class threshold for regurgitation:
        classThr = 3;
    else
        predWithMaxGrade = false;
        % default is default class threshold for stenosis:
        classThr = 2;
    end
...
predictionsPadded = predMatrix(:,VHD_ind);
