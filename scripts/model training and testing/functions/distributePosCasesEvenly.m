...
% Used in CV to ensure equal number of positive cases in each validation
% set. I is a logical index vector that indicates lindear index of positive
% cases. Returns a cell array of size 1 by Nsets that contains linear
% indeces for each validation set after ensuring equal numbers of positive
% cases in each.
%% example input
% Nsplits = 8;
% I = rand(100,1)>0.7;
