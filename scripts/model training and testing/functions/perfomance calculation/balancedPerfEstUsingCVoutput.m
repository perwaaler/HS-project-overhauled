function [perf,AUC] = balancedPerfEstUsingCVoutput(A,Y,K)
% The elements of A a(i) are validation set ACTIVATIONS contained in a cell
% array generated during K-fold cross-validation. Y is a LOGICAL ground
% TRUTH index-vector. If A is logical, then function returns estimated
