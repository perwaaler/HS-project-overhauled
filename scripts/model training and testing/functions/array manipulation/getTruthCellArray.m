function TargetArray = getTruthCellArray(data,IdxArray,TargetVariable,classThr)
...
for i=1:sz(1)
    for aa=1:sz(2)
        ...
        if isempty(classThr)
            TargetArray{i,aa} = data.(varStr)(IdxArray{i,aa});
        else
            TargetArray{i,aa} = data.(varStr)(IdxArray{i,aa})>=classThr;
        end
    end
end
