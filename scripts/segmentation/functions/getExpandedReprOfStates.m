...
% the nodes, which contains starting points for each state, state values
% corresponding to the nodes, and the length of the timeseries that
% corresponds to the state vector. Function is intended to be used in
